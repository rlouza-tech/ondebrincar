/**
 * DestaquesTrilhaMobile — testes unitários (US-I49)
 */
...
function render(destaques: Atracao[]) {
  act(() => {
    createRoot(container).render(<DestaquesTrilhaMobile destaques={destaques} />);
  });
}

describe("DestaquesTrilhaMobile — US-I49", () => {
  beforeEach(() => {
  ...
  it("renderiza um card por destaque com 3 itens (mínimo, mesmo AC2 de US-I43)", () => {
    render(tresDestaques);
    expect(container.querySelectorAll("a").length).toBe(3);
  });

  it("renderiza um card por destaque com 4 itens (máximo, mesmo AC2 de US-I43)", () => {
