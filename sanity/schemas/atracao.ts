...
export const atracao = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Origem",
      type: "string",
      description: "Origem do link de compra. Ex.: sympla, eventim, clubinho, raindrop, uhuu, ecovilla ou outro.",
      options: {
        list: [
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: "🔁 Duplicada", value: "duplicada" },
        ],
        layout: "radio",
      },
